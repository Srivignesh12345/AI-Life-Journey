  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: active ? `0 0 16px ${step.color}55` : hover ? `0 0 10px ${step.color}33` : "none",
        transition: "all 0.2s",
      }}
    >
      {step.emoji} {glitch}
...
function ActiveCard({ step, index }) {
  ...
  return (
    <div style={{
      ...
      <h3 style={{ fontFamily: "monospace", fontSize: 20, fontWeight: 800, color: step.color, marginBottom: 16 }}>
        {glitchLabel}
      </h3>
      <p style={{ fontFamily: "monospace", fontSize: 14, color: "#cbd5e1", lineHeight: 1.9, minHeight: 80 }}>
        {typed}
...
export default function Journey() {
  ...
  return (
    <section style={{ minHeight: "100vh", background: "#0d0d14", padding: "80px 24px", display: "flex", flexDirection: "column", alignItems: "center" }}>

      <p style={{ fontFamily: "monospace", fontSize: 11, color: "#60a5fa", letterSpacing: 4, textTransform: "uppercase", marginBottom: 12 }}>The Journey</p>
      <h2 style={{ fontFamily: "monospace", fontSize: "clamp(1.8rem, 4vw, 2.5rem)", fontWeight: 800, color: "#ffffff", marginBottom: 48, textAlign: "center" }}>
